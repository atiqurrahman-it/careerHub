...
const job = ({id,logo,title,remoteOrOnsite,fulltimeOrPartTime,Cname,location,salary}) => {
    return (
        <div className='md:flex my-10 md:justify-between items-center '>
           ...
           <div className='flex-grow-1'>
               ...
               <p className="text-info mb-3">{Cname}</p>
                <div className="md:flex justify-start gap-3 mb-3">
